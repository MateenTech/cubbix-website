...
export const Services = () => {
  return (
    <div id='services' className='w-full min-h-screen bg-slate-200'>
      <section className='w-full min-h-screen  xl:max-w-7xl xl:mx-auto py-16'>
        ...
        xl:grid-cols-3'>
          {
            services.map((service) => {
              ...
              return (
                <li key={category} className='bg-slate-100 p-9 rounded-xl cursor-pointer group hover:bg-slate-900 shadow-xl'>
